...
| `logo-white.png` | Logo, white variant |
| `logo-on-dark.png` | Logo, dark background |
| `icon.png` | App/favicon-style icon, light background |
| `icon-512.png` | Icon, 512×512 |
| `icon-transparent-256.png` | Icon, 256×256, transparent |
| `og.png` | Open Graph / link-preview image |
| `twitter.png` / `twitter.jpg` | Twitter/X card image |
